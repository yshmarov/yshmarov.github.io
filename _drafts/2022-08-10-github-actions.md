  ...
  test:
    ...
    steps:
      ...
      - name: Run tests
        env:
          RAILS_ENV: test
          DATABASE_URL: postgres://postgres:password@localhost:5432/superails_test
...
https://github.com/joemasilotti/railsdevs.com/tree/main/.github/workflows
